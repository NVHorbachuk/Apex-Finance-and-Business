        ...
        <div className="min-h-screen bg-gray-100 font-['Inter'] text-gray-800 p-4">
            ...
            <header className="relative bg-white pt-16 pb-20 px-4 md:px-8 shadow-md rounded-lg">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 md:space-x-12">
                    <div className="md:w-1/2 text-center md:text-left">
                        <p className="text-sm uppercase tracking-wider text-gray-500 mb-2">ApexGuardian</p>
                    ...
                    <div className="md:w-1/2 grid grid-cols-3 gap-4 p-4 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl shadow-xl">
                        {[
                            ...
                            <img key={index} src={src} alt={`ApexGuardian NFT ${index + 1}`} className="w-full h-auto rounded-xl object-cover shadow-sm" />
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-12 md:space-y-0 md:space-x-16">
                    <div className="md:w-1/2 text-center md:text-left">
                        ...
                        <h2 className="text-4xl font-extrabold leading-tight mb-6">
                            Привіт! Я ApexGuardian <span className="text-pink-500 text-5xl">🛡️</span>
                        </h2>
                    ...
                    <div className="md:w-1/2 flex justify-center">
                        {/* */}
                        <img src="https://placehold.co/600x400/D1FAE5/065F46?text=ApexGuardian" alt="ApexGuardian" className="rounded-xl shadow-lg max-w-full h-auto" />
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 px-4 md:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-3xl font-bold mb-10">У нашого ApexGuardian 8 особистостей, яка ваша?</h2>
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-6">
                        <ApexGuardianPersonality image="https://placehold.co/100x100/F0F9FF/0C4A6E?text=NFT" name="Художник" />
                        <ApexGuardianPersonality image="https://placehold.co/100x100/FEF2F2/7F1D1D?text=NFT" name="Мрійник" />
                        <ApexGuardianPersonality image="https://placehold.co/100x100/F0FDF4/166534?text=NFT" name="Науковець" />
                        <ApexGuardianPersonality image="https://placehold.co/100x100/ECFDF5/047857?text=NFT" name="Контролер" />
                        <ApexGuardianPersonality image="https://placehold.co/100x100/FFF7ED/9A3412?text=NFT" name="Дослідник" />
                        <ApexGuardianPersonality image="https://placehold.co/100x100/F5F3FF/5B21B6?text=NFT" name="Майстер" />
                        <ApexGuardianPersonality image="https://placehold.co/100x100/F0F9FF/0C4A6E?text=NFT" name="Мандрівник" />
                        <ApexGuardianPersonality image="https://placehold.co/100x100/FEF2F2/7F1D1D?text=NFT" name="Новатор" />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl shadow-lg text-left">
                            <h3 className="text-2xl font-bold mb-4">Розблокуйте силу ApexGuardian</h3>
                            <p className="text-gray-700 mb-4">
                                Отримайте необмежений доступ до всіх поточних та майбутніх функцій існуючої програми ApexGuardian. Це більше, ніж просто скарбничка; це повна інтеграція ApexGuardian Family! Ніколи не обмежуйте себе.
                            </p>
                            <p className="text-sm text-gray-500">✔️ 03/2022</p>
                            {/* */}
                            <img src="https://placehold.co/400x250/C7D2FE/3730A3?text=Unlock+ApexGuardian" alt="Unlock ApexGuardian" className="mt-6 rounded-lg shadow-md" />
                        </div>
                        <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl shadow-lg text-left">
                            <h3 className="text-2xl font-bold mb-4">Отримайте ексклюзивний доступ до ApexGuardian</h3>
                            <p className="text-lg text-gray-700 mb-4">
                                Насолоджуйтесь пріоритетним доступом до мерчу ApexGuardian, дропів, розіграшів, квестів та ексклюзивних подій, що зарезервовані лише для власників токенів. І ви не просто власник токена, ви — один з нас!
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-16 w-full max-w-5xl">
                            ...
                            <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-right md:justify-end">
                                <div className="md:w-1/2 order-2 md:order-1 p-4">
                                    ...
                                    <p className="text-gray-700">
                                        У вас коли-небудь був ApexGuardian? NFT на Ethereum, Solana, Cardano? Як їх відстежити?
                                    </p>
                                </div>
                                <div className="md:w-1/2 order-1 md:order-2 flex justify-center p-4">
                                    {/* */}
            ...
            <section className="py-20 px-4 md:px-8 bg-white">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-12 md:space-y-0 md:space-x-16">
                    ...
                    <div className="md:w-1/2 text-center md:text-left">
                        ...
                        <p className="text-lg text-gray-700 mb-6">
                            Чи думали ви коли-небудь, як купити біткойн? Або швидко обміняти одну криптовалюту на іншу через ApexGuardian for Crypto — у вас буде все. Обміняйте свої існуючі криптовалюти на інші або купуйте криптовалюти за допомогою картки? Все це можна зробити всього за кілька кроків.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 px-4 md:px-8 bg-gray-50">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-4xl font-extrabold mb-12">Команда ApexGuardian</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <TeamMember name="Тетяна" role="Маркетолог" avatar="https://placehold.co/100x100/ECFDF5/047857?text=L" /> {/* Без конкретного URL, буде використовувати '#' */}
                    </div>
            ...
            <footer className="bg-gray-800 text-white py-10 px-4 md:px-8 text-center">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex justify-center space-x-6 mb-6">
                        ...
                        <a href="https://twitter.com/apexguardian" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                            <i className="fab fa-twitter text-2xl"></i> {/* Twitter icon */}
                        </a>
                        <a href="https://instagram.com/apexguardian" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                            <i className="fab fa-instagram text-2xl"></i> {/* Instagram icon */}
                        </a>
                        <a href="https://facebook.com/apexguardian" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                            <i className="fab fa-facebook-f text-2xl"></i> {/* Facebook icon */}
                        </a>
                    </div>
                    <p>&copy; {new Date().getFullYear()} ApexGuardian NFT. Усі права захищені.</p>
                </div>
            </footer>
        </div>
    );
